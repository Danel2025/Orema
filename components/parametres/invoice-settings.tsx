                    ...
                    <Tabs.Content value="PRO_FORMA">
                      <Flex direction="column" gap="4" pt="4">
                        <Box>
                          ...
                          <TextField.Root {...register("enteteProForma")} placeholder="PRO-FORMA" />
                        </Box>
                        <Box>
                          <Text as="label" size="2" weight="medium" mb="1">
          ...
          >
            <Box style={{ border: "1px solid var(--gray-a6)", borderRadius: 8 }} p="4">
              <Flex direction="column" gap="4">
                ...
                >
                  <TicketPreview settings={watchedValues} typeFacture={previewType} />
                </Box>
