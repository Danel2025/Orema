...
/**
 * KitchenDisplay - Ecran principal du Kitchen Display System (KDS)
 *
...
export function KitchenDisplay({ initialOrders }: KitchenDisplayProps) {
  ...
  const refreshOrders = useCallback(async () => {
    ...
    const result = await getPendingOrders("cuisine", etablissementId);
    ...
    >
      ...
      <Flex justify="between" align="center">
        <Flex align="center" gap="3">
          <CookingPot size={22} weight="bold" style={{ color: "var(--gray-10)" }} />
          <div>
        ...
        <Flex align="center" gap="2">
          ...
          {fullscreenSupported ? <Tooltip content={isFullscreen ? "Quitter le plein ecran" : "Plein ecran"}>
              <IconButton
                variant="surface"
                color={isFullscreen ? "orange" : "gray"}
                size="2"
      ...
      <style>{`
        ...
        @keyframes kds-new-order-glow {
          ...
          50% { box-shadow: 0 0 12px 2px var(--orange-a5); }
        }
