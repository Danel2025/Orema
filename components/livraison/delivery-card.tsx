...
const ACTION_CONFIG: Record<
  StatutLivraison,
  { label: string; icon: typeof Check; color: 'green' | 'blue' | 'violet' | 'red' | 'gray' | 'orange'; nextStatut: StatutLivraison | null }[]
> = {
  EN_PREPARATION: [
    ...
    >
      <Flex direction="column" gap={compact ? '2' : '3'}>
        ...
        <Flex align="start" gap="2">
          <MapPin
            size={14}
            style={{ color: 'var(--gray-10)', marginTop: 2, flexShrink: 0 }}
          />
        ...
        <Flex gap="3" wrap="wrap">
          {livraison.clientNom ? <Flex align="center" gap="1">
        ...
        <Flex justify="between" align="center" wrap="wrap" gap="2">
          ...
          <Flex align="center" gap="3">
            {livraison.livreurNom ? <Flex align="center" gap="1">
            ...
            {livraison.estimationMinutes ? <Flex align="center" gap="1">
          ...
          <Flex gap="2" wrap="wrap" mt="1">
            ...
            {actions.map((action) => {
              ...
              return (
                <Button
                  ...
                  size="1"
                  onClick={() =>
                    action.nextStatut && handleStatutChange(action.nextStatut)
                  }
                  disabled={isPending}
                  style={{ minHeight: 32, cursor: 'pointer' }}
                >
            ...
            <Dialog.Root>
              ...
              <Dialog.Content maxWidth="500px">
                <Dialog.Title>
                  Livraison #{livraison.numeroTicket}
                </Dialog.Title>
                ...
                <Flex direction="column" gap="2" mb="4">
                  ...
                  {livraison.clientNom ? <Flex align="center" gap="2">
