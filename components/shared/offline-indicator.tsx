...
interface OfflineIndicatorProps {
  ...
  pendingCount: number;
  /** Dernière synchronisation réussie (timestamp ISO ou null) */
  lastSyncedAt: string | null;
  /** Callback pour ouvrir le panneau de sync détaillé */
...
export function OfflineIndicator({
  ...
  return (
    <Tooltip content={getTooltipContent(status, pendingCount, lastSyncedAt)} side="bottom">
      <button
        type="button"
      ...
      >
        <Icon
          ...
          strokeWidth={2.5}
          style={{
            animation: status === "syncing" ? "spin 1.5s linear infinite" : undefined,
          }}
        />
